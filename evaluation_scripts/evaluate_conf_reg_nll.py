...
from authorship.lightning_data_modules import MPerClassDataModule
from authorship.lightning_modules import SentenceEncoder
from authorship.ensemble_modules import DistanceRegularizedEncoderNLL
...
model = DistanceRegularizedEncoderNLL.load_from_checkpoint(args.model_checkpoint,
                                                          args=args,
                                                          dataset=author_datamodule.train_dataset
                                                          )
